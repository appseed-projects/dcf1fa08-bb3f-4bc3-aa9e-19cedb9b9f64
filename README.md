...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-07 11:47`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dcf1fa08-bb3f-4bc3-aa9e-19cedb9b9f64.git
$ cd dcf1fa08-bb3f-4bc3-aa9e-19cedb9b9f64
```
